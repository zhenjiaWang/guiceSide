...
public @interface Restriction {
	...
	/**
	 * 
	 * @see org.guiceside.persistence.hibernate.dao.enums.Condition
	 * @return 返回约束条件类型
	 */
	Condition condition();
	...
	/**
	 * @see org.guiceside.persistence.hibernate.dao.enums.Relation
	 * @return 返回连接关系
	 */
	...
	/**
	 * @see org.guiceside.persistence.hibernate.dao.enums.Match
	 * @return 返回模糊匹配方式
	 */
