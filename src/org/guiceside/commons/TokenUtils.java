...
public class TokenUtils {
     ...
     */
    private static String getSessionId(String sessionId, int length) {
    ...
    public static String getToken(String sessionId) {
        return getToken(sessionId, 14,true);
    }

    public static String getToken(String sessionId, int length,boolean flag) {
        String session = getSessionId(sessionId, length);
